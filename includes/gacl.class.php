...
class gacl {
	...
	function gacl( $db=null ) {
		...
		$this->_mos_add_acl( 'administration', 'login', 'users', 'superadministrator', null, null );
		...
		$this->_mos_add_acl( 'administration', 'config', 'users', 'superadministrator', null, null );
		...
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'superadministrator', 'components', 'com_templates' );
		$this->_mos_add_acl( 'administration', 'install', 'users', 'superadministrator', 'templates', 'all' );
		...
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'superadministrator', 'components', 'com_trash' );
		...
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'superadministrator', 'components', 'com_menumanager' );
		
		// access to languages
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'super administrator', 'components', 'com_languages' );
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'superadministrator', 'components', 'com_languages' );
		...
		$this->_mos_add_acl( 'administration', 'install', 'users', 'superadministrator', 'languages', 'all' );
		...
		$this->_mos_add_acl( 'administration', 'install', 'users', 'superadministrator', 'modules', 'all' );

		$this->_mos_add_acl( 'administration', 'edit', 'users', 'super administrator', 'modules', 'all' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'superadministrator', 'modules', 'all' );
		...
		$this->_mos_add_acl( 'administration', 'install', 'users', 'superadministrator', 'mambots', 'all' );

		$this->_mos_add_acl( 'administration', 'edit', 'users', 'super administrator', 'mambots', 'all' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'superadministrator', 'mambots', 'all' );
		...
		$this->_mos_add_acl( 'administration', 'install', 'users', 'superadministrator', 'universals', 'all' );
		...
		$this->_mos_add_acl( 'administration', 'install', 'users', 'superadministrator', 'components', 'all' );
		...
		$this->_mos_add_acl( 'administration', 'install', 'users', 'superadministrator', 'parameters', 'all' );
		...
		$this->_mos_add_acl( 'administration', 'install', 'users', 'superadministrator', 'includes', 'all' );

		$this->_mos_add_acl( 'administration', 'edit', 'users', 'super administrator', 'components', 'all' );
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'superadministrator', 'components', 'all' );
		...
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'superadministrator', 'components', 'com_massmail' );
		...
		$this->_mos_add_acl( 'administration', 'manage', 'users', 'superadministrator', 'components', 'com_users' );
		...
		$this->_mos_add_acl( 'administration', 'edit', 'users', 'superadministrator', 'user properties', 'block_user' );
		...
		$this->_mos_add_acl( 'workflow', 'email_events', 'users', 'superadministrator', null, null );
		...
		$this->_mos_add_acl( 'action', 'add', 'users', 'superadministrator', 'content', 'all' );
		$this->_mos_add_acl( 'action', 'edit', 'users', 'superadministrator', 'content', 'all' );

		$this->_mos_add_acl( 'action', 'publish', 'users', 'super administrator', 'content', 'all' );
		$this->_mos_add_acl( 'action', 'publish', 'users', 'superadministrator', 'content', 'all' );

		// work around for menu access
		$this->_mos_add_acl( 'action', 'access', 'users', 'superadministrator', 'frontend', 'special' );
		$this->_mos_add_acl( 'action', 'access', 'users', 'super administrator', 'frontend', 'special' );
		$this->_mos_add_acl( 'action', 'access', 'users', 'administrator', 'frontend', 'special' );
		$this->_mos_add_acl( 'action', 'access', 'users', 'manager', 'frontend', 'special' );
		$this->_mos_add_acl( 'action', 'access', 'users', 'publisher', 'frontend', 'special' );
		$this->_mos_add_acl( 'action', 'access', 'users', 'editor', 'frontend', 'special' );
		$this->_mos_add_acl( 'action', 'access', 'users', 'author', 'frontend', 'special' );
